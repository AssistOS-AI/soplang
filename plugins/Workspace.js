...
async function Workspace() {
    ...
    self.createWorkspace = async function (workspaceName, ownerId, spaceGlobalId) {
        const webAssistant =  $$.loadPlugin("WebAssistant");

        const assistant = await webAssistant.createWebAssistant();
...
export function getDependencies() {
    return ["DefaultPersistence", "EmailPlugin", "WorkspaceUser","WebAssistant"];
}